  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-premium text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6 sm:space-y-8">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight px-2">Ready to Unlock Your Investment Potential?</h2>
        ...
        >
          ...
          <ArrowRight size={18} className="sm:w-5 sm:h-5 group-hover:translate-x-1 transition-smooth" />
        </Link>
      </div>
    </section>
  )
