...
export default function RouteSelectionPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 page-transition">
      {/* Header */}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <Card className="p-6 sm:p-8 bg-white shadow-lg mb-6 animate-scale-in delay-200">
          ...
          <div className="space-y-4 mb-8">
            ...
            <button
              ...
              className={`w-full text-left p-6 rounded-lg border-2 transition-all duration-300 card-hover ${
        ...
        <Card className="p-6 sm:p-8 bg-white shadow-lg mb-6 animate-scale-in delay-300">
          <h2 className="text-2xl font-bold text-[#2E4059] mb-6">
            Who are you?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              ...
              className={`p-4 rounded-lg border-2 transition-all duration-300 card-hover ${
        ...
        <div className="flex justify-end mt-6">
          <Button
            ...
            className="bg-[#FFC72F] text-[#2E4059] font-bold hover:bg-[#FFC72F]/90 disabled:opacity-50 disabled:cursor-not-allowed px-8 py-6 text-lg transition-all duration-300 hover:scale-105"
          >
            Continue
          </Button>
        </div>
