...
export function HomePageClient({
  ...
  const pf = playfairClassName;
  const sy = syneClassName;

  return (
    <main className={`catalyst-page ${sy}`}>
      <nav className={`c-nav ${scrolled ? "scrolled" : ""}`}>
        <div>
          <span className={`c-nav-logo-main ${pf}`}>SewAsset</span>
          <span className="c-nav-tm">TM</span>
        </div>
        ...
        <Link className="c-nav-cta" href="/disclaimer?next=%2Froute-selection">
          Start Assessment →
        </Link>
      </nav>
      ...
      <section className="c-hero">
        ...
        <div className="c-hero-inner">
          <div>
            ...
            <h1 className={`c-h1 ${pf} c-animate c-delay-1`}>
            ...
            <div className="c-actions c-animate c-delay-3">
              <Link href="/disclaimer?next=%2Ftraining" className="c-btn-primary">
            ...
            <div className="c-hero-stats c-animate c-delay-4">
              <div>
                <div className={`c-stat-value ${pf}`}>400+</div>
                <div className="c-stat-label">Training Modules</div>
              </div>
              <div>
                <div className={`c-stat-value ${pf}`}>7</div>
                <div className="c-stat-label">Capability Pillars</div>
              </div>
              <div>
                <div className={`c-stat-value ${pf}`}>SPSC</div>
                <div className="c-stat-label">Diagnostic Model</div>
              </div>
              <div>
                <div className={`c-stat-value ${pf}`}>15 min</div>
      ...
      <section id="problem" style={{ background: "#fdfcf9" }}>
        <div className="c-section">
          ...
          <h2 className={`c-title ${pf} c-animate c-delay-1`}>
          ...
          <div className="c-problem-grid c-animate c-delay-3">
            ...
            <div className="c-problem-right c-glide-right">
              <h3 className={pf}>SewAsset Catalyst™ bridges the gap.</h3>
      ...
      <section id="engine" className="c-engine">
        <div className="c-section" style={{ color: "white", paddingTop: 0, paddingBottom: 0 }}>
          ...
          <h2 className={`c-title ${pf} c-animate c-delay-1`} style={{ color: "white" }}>
            Three stages.
            <br />
          ...
          <div className="c-engine-grid c-animate c-delay-2">
            <article className="c-engine-card c-card-pop" data-step="01">
              ...
              <h3 className={pf}>Capability Diagnostics</h3>
              <p>
            ...
            <article className="c-engine-card c-card-pop" data-step="02">
              ...
              <h3 className={pf}>Training Architecture</h3>
              <p>
            ...
            <article className="c-engine-card c-card-pop" data-step="03">
              <span className="c-engine-icon">📊</span>
              <h3 className={pf}>Business Case Generation</h3>
              <p>
        ...
        <div className="c-section">
          ...
          <div className="c-model-diagram c-animate c-delay-2">
            ...
            <div className="c-model-center">
              ...
              <div className={`c-model-center-title ${pf}`}>Catalyst Engine™</div>
        ...
        <div className="c-section">
          ...
          <div className="c-who-grid c-animate c-delay-2">
            <div className="c-who-card c-card-pop">
              ...
              <div className={`c-who-card-title ${pf}`}>Business Leaders</div>
            ...
            <div className="c-who-card c-card-pop">
              ...
              <div className={`c-who-card-title ${pf}`}>HR &amp; L&amp;D Professionals</div>
              <div className="c-who-card-desc">
            ...
            <div className="c-who-card c-card-pop">
              ...
              <div className={`c-who-card-title ${pf}`}>Consultants &amp; Partners</div>
              <div className="c-who-card-desc">
            ...
            <div className="c-who-card c-card-pop">
              ...
              <div className={`c-who-card-title ${pf}`}>Individual Professionals</div>
              <div className="c-who-card-desc">
      ...
      <section className="c-spsc-section">
        <div className="c-section">
          ...
          <h2 className={`c-title ${pf} c-animate c-delay-1`}>The SPSC™ Diagnostic Model</h2>
          ...
          <div className="c-spsc-grid c-animate c-delay-3">
            <article className="c-spsc-card c-card-pop">
              <div className={`c-spsc-letter ${pf}`}>S</div>
            ...
            <article className="c-spsc-card c-card-pop">
              <div className={`c-spsc-letter ${pf}`}>P</div>
            ...
            <article className="c-spsc-card c-card-pop">
              <div className={`c-spsc-letter ${pf}`}>C</div>
      ...
      <section className="c-entry">
        ...
        <div className="c-entry-inner">
          ...
          <h2 className={`c-entry-title ${pf} c-animate c-delay-1`}>
          ...
          <div className="c-entry-paths c-animate c-delay-3">
            <Link href="/disclaimer?next=%2Ftraining" className="c-entry-path c-card-pop">
            ...
            <Link href="/disclaimer?next=%2Fconsulting" className="c-entry-path c-card-pop">
      ...
      <footer className="c-footer">
        <div className={`c-footer-logo ${pf}`}>
        ...
        <div className="c-footer-copy">© 2025 SewAsset. All rights reserved.</div>
      </footer>
    </main>
  );
}
